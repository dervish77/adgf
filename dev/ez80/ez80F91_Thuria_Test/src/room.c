...
ROOM_S_T room[] = {
 0, 1, "You are standing inside a small entrance chamber.  There is debris",
 0, 2, "scattered all over the floor.  A wide passageway leads north.",
 0, -1, " ",

 1, 1, "You are in a small antechamber behind the throne.  Several tapestries",
 1, 2, "of exquisite design hang on the walls.  They appear permanent.",
 1, -1, " ",

 2, 1, "A large ornate throne sits prominently in the center of the room.  A",
 2, 2, "set of heavy green draperies cover the wall to the west behind the",
 2, 3, "throne.  A smell of decay and death hangs within the room.  The only",
 2, 4, "exit appears to be the one you entered from the east.",
 2, -1, " ",

 3, 1, "You are in a long corridor with doorways to the east, west, and",
 3, 2, "south.  The walls are painted red over a stucco finish.",
 3, -1, " ",

 4, 1, "This is the castle's dining hall.  Several long tables are covered",
 4, 2, "with various food scraps and broken dishes.  There is a pair of",
 4, 3, "swinging doors to the east.",
 4, -1, " ",

 5, 1, "This a decent sized kitchen for a castle.  An open fire pit sits to",
 5, 2, "one side.  Several tables are covered with yet more food scraps.  A",
 5, 3, "large rat can be seen foraging in a corner.",
 5, -1, " ",

 6, 1, "This is a very small room, perhaps only six feet square.  Broken",
 6, 2, "pieces of lumber are piled up in one corner.",
 6, -1, " ",
 
 7, 1, "You are in a very large hall with exits on all sides.  The walls are",
 7, 2, "paneled with antique oak that has been varnished to a high gloss.",
 7, 3, "High above you hangs an elaborate chandelier.  Several candle holders",
 7, 4, "are placed around the room on the walls.",
 7, -1, " ",

 8, 1, "A damp grey mist swirls around at your feet whenever you move.  A set",
 8, 2, "of stairs lead downward into darkness.  An exit is to the west.",
 8, -1, " ",

 9, 1, "Before you stands the largest beaver dam you have ever seen.  It is",
 9, 2, "a marvelous work of engineering.  It must be some two hundred feet",
 9, 3, "in length and over six feet high.  A trail heads back to the south",
 9, 4, "and an overgrown path winds to the north around the pond.",
 9, -1, " ",

10, 1, "You have climbed high above the valley floor and are now standing next",
10, 2, "to a narrow river with a swiftly moving current.  A trail winds north.",
10, 3, "A somewhat wider path leads east.",
10, -1, " ",

11, 1, "You are standing next to a large beaver pond.  There are several",
11, 2, "beavers nearby munching on tree bark.  The dense forest prohibits",
11, 3, "travel except to the south.  A light breeze ripples the pond.",
11, -1, " ",

12, 1, "You have ascended into a long valley, filled with mist.  The mist",
12, 2, "swirls around your head making you feel somewhat light-headed.  A",
12, 3, "small stream trickles nearby.  Impassable mountain ranges to the north",
12, 4, "and south prohibit travel in those directions.  A narrow path slopes",
12, 5, "slightly upwards to the west.  A well traveled road leads east.",
12, -1, " ",

13, 1, "You are outside a modest castle.  All is quiet, only a slight breeze",
13, 2, "rustles the leaves on the trees.  A road leads west and east.  A",
13, 3, "massive wooden door with several shiny brass hinges is facing you.",
13, -1, " ",

14, 1, "A babbling brook interrupts the trail.  The sound is quite",
14, 2, "relaxing.  The trail appears to continue east a bit more, though",
14, 3, "it looks kind of swampy and foreboding.",
14, -1, " ",

15, 1, "The darkness of this room swallows the glow from your lantern.  From",
15, 2, "somewhere just beyond your sight a hollow voice says \"plugh\".  After",
15, 3, "groping around in the darkness you find the only exit is to the east.",
15, -1, " ",
...
22, 1, "A wide set of stairs lead up from the middle of the eastern wall.",
22, 2, "Additional doorways lead north and south.  A life-sized statue of a",
22, 3, "native american indian stands along the wall across from the stairs.",
22, -1, " ",
