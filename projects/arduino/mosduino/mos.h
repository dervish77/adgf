 ...
 */
#define MAX_TASKS		5       /* max number of tasks */
#define MAX_TASK_MEM_SIZE	64      /* max size of task memory block in bytes */
...
typedef struct memblock_s_t
{
    ...
    char buf[MAX_TASK_MEM_SIZE];/* static memory buffer */
