...
# arduino-cli
export PATH="$PATH:/cygdrive/c/Utils/arduino-cli_0.19.2_Windows_64bit"
...
export EDITOR="/cygdrive/c/Utils/Notepad++/Notepad++.exe"
...
# -- SPITFIRE
#
alias spitfire='cd ~/spitfire'


#
# -- Walnut
#
alias walnut='cd ~/gitwork/nrtg/walnut'
...
# Phelps
alias phelps='cd /home/bl12960/gitwork/nrtg/Phelps_FW'
...
alias lizzodemo='cd ~/gitwork/nrtg/lizzo_demo/rio'
...
alias gitkey='eval $(ssh-agent -s) ; ssh-add ~/.ssh/id_rsa'
alias gitkey77='eval $(ssh-agent -s) ; ssh-add ~/.ssh/id_ed25519'
...
alias testengineapp='TestEngineApp.exe'
...
export PATH=$PATH:/cygdrive/c/Utils/VideoLAN/VLC:/cygdrive/c/Utils/RioTools
