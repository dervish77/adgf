/********************************************************
*
* Remote calling client test program.
*
* File:   remtest.c
*
...
*
* Notes:  Remote uses 'rexec' to remotely execute a command
...
static char *username = "lingard";
static char *password = "mudhoney";
   ...
   char  *argv[];
{
   ...
   /*  execute command string remotely using rexec
    */
   sockfd1 = rexec( ahost, 			/* ahost */
			pse->s_port, 		/* remport */
			username, 		/* servuname */
			password, 		/* password */
			cmd_string, 		/* cmd */
   ...
   if ( sockfd1 < 0 )
   {
      fprintf(stderr, "error: rexec failed\n\n");
      exit(1);
   }
