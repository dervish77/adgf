...
; ***                 D - Error code  ***
; ***************************************
read:      glo     rb                  ; save consumed registers
           stxd
           ghi     rb
           stxd
           glo     r9
...
writelp:   glo     rc                  ; see if more bytes to read
           ...
           glo     rb
           plo     rc
writeex:   irx                         ; recover consumed registers
           ldxa
           phi     r9
           ldxa
           plo     r9
...
; ***                 D - Error code ***
; **************************************
close:     sep     scall               ; see if sector needs to be written
           dw      checkwrt
...
setupfd:   sep     scall               ; set dir sector
           ...
           dw      rawread
           ldi     0                   ; set initial flags to zero
           sep     scall
           dw      setfdflgs
...
start:     sep     scall               ; force ide reset
           dw      f_idereset
...
bootmsg:   db      'Starting Elf/OS ...',10,13
           db      'Version 0.2.8',10,13
           db      'Copyright 2004-2006 by Michael H Riley',10,13,0
