...
memTrap = 0;
  ...
  while (i<argc) {
    ...
    if (strcmp(argv[i],"-v") == 0) printf("RC/Elf v2.4b\n");
  ...
  clockOpen = 'N';
  if (use1870 == 'Y') {
    v1870Window=rcs_createWindow(display,rcs_rootWindow(display),10,10,240,216);
    rcs_setWindowName(display,v1870Window,"Elf 1870");
    rcs_showWindow(display,v1870Window);
    v1870Buffer=rcs_createPixmap(display,v1870Window,240,216);
    rcs_namedForeground(display,gc,"black");
    rcs_drawFilledBox(display,v1870Buffer,gc,0,0,240,216);
    }
  ...
  if (graphics =='Y') {
    pixieWindow=rcs_createWindow(display,rcs_rootWindow(display),10,10,256,256);
    ...
    pixieBuffer=rcs_createPixmap(display,pixieWindow,256,256);
    rcs_drawFilledBox(display,pixieBuffer,black,0,0,256,256);
    rcs_copyArea(display,pixieBuffer,pixieWindow,gc,0,0,256,256,0,0);
    }
  if (useTMS9918 =='Y') {
    vdp = tms9918_init();
    }
