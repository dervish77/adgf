...
void init_display(int argc, char **argv, MyProgram *me)
{
  ...
  SetWidgetPos(w[STATUS_AREA_IDX], PLACE_UNDER, w[SCORE_AREA_IDX], NO_CARE, NULL);
  SetWidgetPos(w[DRAW_AREA_IDX], PLACE_UNDER, w[STATUS_AREA_IDX], NO_CARE, NULL);
  ...
  SetFgColor(w[STATUS_AREA_IDX], GREEN);
