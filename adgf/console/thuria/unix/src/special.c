...
SPECIAL_S_T special[] = {
0,   0, "An empty treasure chest sits in the corner.", 	
1,   0, "A treasure chest sits in the corner, which contains:",
2,   0, "The door is shut tight and padlocked.",
3,  10, "The door is shut tight.  A padlock hangs loose.",
4,   0, "The door is open.  A padlock dangles from a rung.",
5,   0, "A rotting skeleton sits upon the throne.",
6,   0, "The skeleton has risen and is attacking you.",
7,  10, "A rotting skeleton lays crumpled in a heap on the floor.",
8,   0, "One beaver in particular looks a bit hungry.",
9,   0, "Having ignored your offering, one beaver tries to bite your leg.",
10,  0, "There is the bloody carcass of a beaver here.",
11,  0, "There is a heavy wooden door, which is closed.",
12,  0, "There is a heavy wooden door, which is open.",
13,  0, "A sign nearby warns against swimming in the river.",
14,  0, "A yellow sign nearby warns against swimming in the river.",
15,  0, "The statue is pointing a bow and arrow towards the north.",
16, 10, "The statue is pointing a bow and arrow towards the south.",
