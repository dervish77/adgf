/********************************************************
*
* GAME client program example
*
* File:   game.c 	- TCPgame, main
*
* Rev 0.0  10/21/97  Originated
*
* Author: Brian Lingard
*
* Usage:  game <host> [<port>]
*
   ...
   char *port;
{
   ...
   printf("TCPgame: connection to %s closed\n", host);
}


/* main - TCP client for GAME service */
int
main(argc, argv)
   int   argc;
   char  *argv[];
