...
int drawTextInit(char *font)
{
    ...
    text.fgColor = CLR_WHITE;
    text.bgColor = CLR_BLACK;
...
{    
    drawText(string, text.size, x, y, text.fgColor, text.bgColor);
}
...
{    
    ...
    TTF_Font *font = TTF_OpenFont( text.fontName, text.size );
    if (!font)
    {
    ...
    {
        SDL_Color foreColor = CreateSDLColorFromLongColor( text.fgColor );
        SDL_Color backColor = CreateSDLColorFromLongColor( text.bgColor );
