...
void GamePattern(GAME_S_T *pGame)
{
    ...
    {
        case PATTERN_SPIN:
            pGame->board[11][10].piece_type = PIECE_TYPE_UFO;
            pGame->board[11][11].piece_type = PIECE_TYPE_UFO;
            pGame->board[11][12].piece_type = PIECE_TYPE_UFO;
            break;
        case PATTERN_BEACON:
            pGame->board[10][10].piece_type = PIECE_TYPE_ROID;
            pGame->board[11][10].piece_type = PIECE_TYPE_ROID;
            pGame->board[10][11].piece_type = PIECE_TYPE_ROID;
            pGame->board[13][12].piece_type = PIECE_TYPE_ROID;
            pGame->board[12][13].piece_type = PIECE_TYPE_ROID;
            pGame->board[13][13].piece_type = PIECE_TYPE_ROID;
            break;
        case PATTERN_GLIDER:
