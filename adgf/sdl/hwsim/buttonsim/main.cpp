...
void DoUnitTest()
{
    // configure buttonsim for default number of buttons
    int init_okay = ButtonSim_Init( BUTTON_COUNT_DEFAULT );

    // loop on running the sim
    if (init_okay)
    {
        ButtonSim_Execute( );
    }
